    ...
    <div id="show">
        ...
        <div class="cart-inner">
                        ...
                        <div class="cell p-goods">
                            <div class="p-img">
                                <a href="/item/${cart.id }.html" target="_blank">
                                    <img clstag="clickcart|keycount|xincart|p-imglistcart" src="/images/543b4d75N686689d7.jpg" alt="${cart.name}" width="52" height="52">
                                </a>
                            </div>
                            <div class="p-name">
                                <a href="/item/${cart.id }.html" clstag="clickcart|keycount|xincart|productnamelink" target="_blank">
                                <span class="promise411 promise411_11345721" id="promise411_11345721">${cart.name}</span>
                                </a>
                            </div>
                        </div>
                        <div class="cell p-price"><span class="price">¥${cart.price}  </span></div>
            ...
            <div class="cart-toolbar clearfix">
                <div class="total fr">
                    <p>总计：¥<span class="totalSkuPrice"></span></p>
              ...
              <span class="column t-checkbox form">
                ...
                <div class="cart-total-2014">
                  ...
                  <span class="check-comm-btns" id="checkout-jd">
                      <a class="checkout" href="/order/computer" clstag="clickcart|keycount|xincart|gotoOrderInfo" id="toSettlement">去结算<b></b></a>
                  </span>
