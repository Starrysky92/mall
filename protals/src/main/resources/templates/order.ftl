    ...
    <div class="goods-suit goods-last">
	 <#list cart as cart>
		<div class="goods-item goods-item-extra">
			...
			<div class="p-img">
				<a target="_blank" href="/${cart.id}.html">
					<img src="/images/543b4d75N686689d7.jpg" alt="">
				</a>
			</div>
			<div class="goods-msg">
				<div class="p-name">
					<a href="/${cart.id}.html" target="_blank">
						${cart.name } 
					</a>
				</div>
				<div class="p-price">
		...
		<div class="order-summary">
			...
			<div class="statistic fr">
				<div class="list">
					...
					<em class="price" id="warePriceId">¥${100}</em>
				</div>
				<div class="list">
      ...
      <div class="sticky-wrap">
          ...
          <button type="submit" class="checkout-submit btn-1" 
          	...
          	提交订单
                    ...
                    <span class="total">应付总额：<strong id="payPriceId">￥${100}</strong>
          </span>
